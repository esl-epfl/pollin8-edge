...
#    For the DEPLOYED baseline use full-val fitness + best-of-3 (48_base_fullval_seeds.sbatch);
#    the arch sweep uses a 1,500-image fast-val subset (tiled_fastval.yaml — see the sbatch header):
